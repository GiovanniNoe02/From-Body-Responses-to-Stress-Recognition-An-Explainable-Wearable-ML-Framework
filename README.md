...
* **BDBP_Project_v2.ipynb** – Jupyter Notebook containing the complete analysis pipeline, including data preprocessing, feature extraction, exploratory data analysis, machine learning classification, and explainability analysis.
* **From Bodily Responses to Stress Recognition.pdf** – Final project report.
* **Questionnaires - Scores.csv** – Processed questionnaire responses and computed psychological scores used for the validation of the experimental conditions.
